          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">
                        Sanayi Mah Kozalı Sk Çarşı Yapı Avm A Blok No 10 <br />
                        İzmit/Kocaeli
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-100 rounded-lg overflow-hidden h-80">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d188.89725060413681!2d29.953586903157053!3d40.75419392408479!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cb45e6065eed53%3A0x5aac5e82e95287e4!2sTa%C5%9Fdanlar%20Otomotiv%20(Merkez)!5e0!3m2!1str!2str!4v1745191195190!5m2!1str!2str"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
